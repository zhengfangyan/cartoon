  ...
  methods: {
    Contentlist(){
      ...
      this.axios.get(url).then(result=>{
        this.list=result.data.data.splice(63,25);
      })
    }
  },
  created() {
...
<style>
  *{margin:0;padding:0;}
  ...
  /* 主体 */
   .app-end .container .contant{
     margin-top:60px;
   }
  .app-end .container .media{
   margin-top:0.3rem;
   width:100%;
  }
  .app-end .container .media .media-body .p1{
    color:#333;
    font-size:1.5rem;
  }
  .app-end .container .media .media-body .m_img{
  ...
  .app-end .container .media .media-body .m_i1{
    background-position: 2px -18px;
  }
  .app-end .container .media .media-body .m_i2{
    background-position: 61px -18px;
  }
  .app-end .container .media .media-body .m_i3{
